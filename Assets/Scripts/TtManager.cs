...
public class TtManager : MonoBehaviour
{
    ...
    public void text_flow()     // 이전&다음 버튼 터치에 따른 흐름
    {
        ...
        {
            case 0:
                txt.text = "’뱅!’은 무법자 집단과 보안관이 펼치는 서부시대 풍의 총격전 카드게임입니다. \n" +
                ...
                break;
            case 1:
                txt.text ="뱅 게임은 7장의 직업카드, 16장의 캐릭터카드, 80장의 행동카드로 구성되어 있습니다.\n" +
            ...
            case 2:
                ...
                break;
            case 3:
                txt.text = "화면에 뜬 텍스트는 플레이어 수에 따라 분배하는 직업카드 종류와 장수입니다.\n" +
            ...
            case 4:
                ...
                break;
            case 5:
                txt.text = "캐릭터카드에 표시된 총알 개수는 캐릭터의 최대 생명력을 의미하며, 플레이어는 그만큼의 총알 토큰을 가지게 됩니다. \n" +
                ...
                break;
            case 6:
                txt.text = "행동카드는 실질적인 게임 진행에 사용되며, 각각의 행동카드는 저마다의 기능을 가지고 있습니다. \n" +
                ...
                break;
            case 7:
                txt.text = "갈색의 행동카드는 일회성으로, 자신의 차례에서 원하는 만큼 사용할 수 있습니다. \n" +
                ...
                break;
            case 8:
                txt.text = "뱅 게임 플레이를 위해 꼭 알아 두어야 하는 것이 '거리' 개념입니다.\n" +
                ...
                break;
            case 9:
                txt.text = "예를 들어 내가 '볼캐닉' 무기 카드를 장착 중이고 '뱅' 행동카드를 사용하려 한다면, 나와 거리가 1 이하인 플레이어, 즉 A,D에게 사용 가능합니다.\n" +
                    "이처럼 거리 개념은 일부 행동 카드(특히 무기 카드)의 사용과 직결되므로 꼭 숙지한 후 게임을 플레이해 주세요.";
                script_minimap.enable();  // 미니맵 Image 스크립트의 enable()함수를 호출한다.
                script_minimapCard.enable();  // 미니맵카드 Image 스크립트의 enable()함수를 호출한다.
                break;
            case 10:
                txt.text = "'뱅!' 게임 플레이를 위한 기본 개념 설명은 여기까지입니다. \n" +
